...
CREATE INDEX "rooms_created_by_id_idx" ON "rooms" USING btree ("created_by_id");--> statement-breakpoint
CREATE INDEX "rooms_created_at_idx" ON "rooms" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "rooms_is_public_idx" ON "rooms" USING btree ("is_public");--> statement-breakpoint
